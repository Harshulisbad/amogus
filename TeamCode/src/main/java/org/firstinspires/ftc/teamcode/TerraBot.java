...
public class TerraBot {
    ...
    public void init(Hardware Map Map) {
        r1 = hwMap.get(DcMotor.class, deviceName = "r1");
        r2 = hwMap.get(DcMotor.class, deviceName = "r2");
        l1 = hwMap.get(DcMotor.class, deviceName = "l1");
        l2 = hwMap.get(DcMotor.class, deviceName = "l2");
